...
# Treadmill class from https://github.com/brandonarbini/treadmill/blob/master/lib/treadmill/treadmill.rb
# Copyright (c) 2013 Brandon Arbini
# License at https://github.com/brandonarbini/treadmill/blob/master/LICENSE.txt
class Treadmill
...
channels.register(:lifespan) {
  specify :walked, [:time, :distance, :speed]

  treadmill = Treadmill.new
  update_every(seconds: 5) {
    walked(treadmill.seconds, treadmill.distance, treadmill.speed)
  }
}
